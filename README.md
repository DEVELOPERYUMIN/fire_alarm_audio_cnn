...
### 1️⃣ 스마트 소방 대피 시스템 (특허 10-1725774)

* 드론이 직접적으로 사람을 대피시키지 못함
* 열화상 카메라의 성능 한계 존재
* 연기가 많을 경우 시야 확보 불가
* 연기 센서가 실내에 사전 설치되어 있어야 작동 가능

### 2️⃣ SKT 4족 보행 로봇 + 화재 감시 AI
...
### 3️⃣ 기존 화재용 비상드론 및 구조 시스템 특허

* 층간 이동은 자유로움
* 로프 기반 구조 가능
* 그러나 실내 자율 탐지 및 복합 센서 기반 대피 유도 기능은 제한적
